  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 mx-5 cursor-pointer hover:text-amber-300 transition">
        ...
        <div className=" text-gray-100 gap-2 mx-5 rounded-xl cursor-pointer hover:text-amber-300 transition">
         ورود / ثبت نام
        </div>
      </div>
    </nav>
