...
export default function ModalPicker({
  ...
  return (
    <div
      dir="rtl"
      className="fixed inset-0 z-50 bg-black/40 flex justify-center md:items-center backdrop-blur-[1px]"
      onClick={onClose}
    >
      <div
      ...
      >
        {/* Drag Handle */}
        <div className="w-12 h-1.5 bg-gray-300/70 rounded-full mx-auto mb-3" />
            ...
            : days.map((day, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    onClick={() =>
                      !isDisabled && setSelectedDate(dayObj)
                    }
